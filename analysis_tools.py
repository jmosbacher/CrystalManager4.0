...
class ProjectAnalysisTool(HasTraits):
    ...
    view = View(HGroup(
                    ...
                    VGroup(
                        ...
                        Item(name='data_df', editor=DataFrameEditor(show_index=False),style='custom', show_label=False),
    ...
    def _export_table_fired(self):
        tool = DataFrameExportTool(self.data_df)
        tool.configure_traits()

    def _groupby_fired(self):
        self.groupby_obj = self.data_df.groupby(self.groupby_choice,as_index=False)
    ...
    def _plot_result_fired(self):
        ...
        if self.plt_matrix:
            ...
            ax = scatter_matrix(self.data_df,**kwargs)
        else:
    ...
    def _apply_agg_fired(self):
        ...
        if arg == 'size':
            ...
            groupby_obj = self.data_df.groupby(self.groupby_choice)
    ...
    def refresh_groupby_list(self):
        self.groupby_list = list(self.data_df.columns.values.flatten())
