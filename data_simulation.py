...
import numpy as np
from measurement import SpectrumMeasurementSimulation
from experiment import SpectrumExperimentSimulation
...
class MeasurementSimulator(HasTraits):
    ...
    def simulate_measurement(self):
        new = SpectrumMeasurementSimulation()
...
class ExperimentSimulator(HasTraits):
    ...
    def simulate_experiment(self):
        new_exp = SpectrumExperimentSimulation()
        ...
        for n, ex_wl in enumerate(ex_wls):
            ...
            meas = SpectrumMeasurementSimulation()
            meas.ex_wl = ex_wl
